...
class getForm_RegistryService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['form.registry'] = new \Symfony\Component\Form\FormRegistry([0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService, [
            'App\\Form\\Type\\AccordionType' => ['privates', 'App\\Form\\Type\\AccordionType', 'getAccordionTypeService', true],
            'App\\Form\\Type\\AvocatsInputType' => ['privates', 'App\\Form\\Type\\AvocatsInputType', 'getAvocatsInputTypeService', true],
            'App\\Form\\Type\\FormationType' => ['privates', 'App\\Form\\Type\\FormationType', 'getFormationTypeService', true],
            'App\\Form\\Type\\MailType' => ['privates', 'App\\Form\\Type\\MailType', 'getMailTypeService', true],
            'App\\Form\\Type\\SecteurActiviteInputType' => ['privates', 'App\\Form\\Type\\SecteurActiviteInputType', 'getSecteurActiviteInputTypeService', true],
            'App\\Form\\Type\\ThemathiquesInputType' => ['privates', 'App\\Form\\Type\\ThemathiquesInputType', 'getThemathiquesInputTypeService', true],
            ...
            'App\\Form\\Type\\AccordionType' => '?',
            'App\\Form\\Type\\AvocatsInputType' => '?',
            'App\\Form\\Type\\FormationType' => '?',
            'App\\Form\\Type\\MailType' => '?',
            'App\\Form\\Type\\SecteurActiviteInputType' => '?',
            'App\\Form\\Type\\ThemathiquesInputType' => '?',
