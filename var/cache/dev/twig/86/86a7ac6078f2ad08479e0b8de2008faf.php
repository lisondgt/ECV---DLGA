...
class __TwigTemplate_9fac5d1be4c5f9adc1df6b2cd5b1b39e extends Template
{
    private $source;
    private $macros = [];
...
{% block panel %}
    ...
    {% endfor %}
{% endblock %}
", "@WebProfiler/Collector/mailer.html.twig", "/Applications/MAMP/htdocs/ECV/DLGA/vendor/symfony/web-profiler-bundle/Resources/views/Collector/mailer.html.twig");
    }
}
