...
/**
 * @extends ServiceEntityRepository<Avocats>
 *
...
class AvocatsRepository extends ServiceEntityRepository
{
    ...
    public function add(Avocats $entity, bool $flush = false): void
    {
    ...
    public function remove(Avocats $entity, bool $flush = false): void
    {
